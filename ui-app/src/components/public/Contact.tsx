...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-30 px-7 sm:px-6 bg-base-200">
      <div className="max-w-6xl mx-auto flex flex-col gap-6 items-center sm:items-start sm:text-left">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
          Contact
        </h2>
        <p className="text-base sm:text-lg text-neutral-content max-w-2xl">
          N’hésitez pas à me contacter par courriel ou à me retrouver sur GitHub et LinkedIn.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 mt-2 items-center sm:items-start w-full sm:w-auto">
          {/* Email link (mailto) */}
          <a href={"mailto:" + siteConfig.email_primary} className="btn btn-primary gap-2 w-55 sm:w-auto">
          ...
          {/* GitHub profile link */}
          <a href={siteConfig.github_url} target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-primary gap-2 w-55 sm:w-auto">
          ...
          <a href={siteConfig.linkedin_url} target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-primary gap-2 w-55 sm:w-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
